...
public class SettingsFragment extends Fragment {
    ...
    private void initBKRadioButtons() {
        mBKSystem = (RadioButton)mContentView.findViewById(R.id.backkey_function_system);
        mBKDisable = (RadioButton)mContentView.findViewById(R.id.backkey_function_disable);
        mBKUndo = (RadioButton)mContentView.findViewById(R.id.backkey_function_undo);
    ...
    private void initRBRadioButtons() {
        ...
        mHandBall = (RadioButton)mContentView.findViewById(R.id.sport_type_handball);
        mHockey = (RadioButton)mContentView.findViewById(R.id.sport_type_hockey);
        mTchoukball = (RadioButton)mContentView.findViewById(R.id.sport_type_tchoukball);
        ...
        switch (sportType) {
            ...
            case SettingManager.SPORT_TYPE_HANDBALL:
                mHandBall.setChecked(true);
                break;
            case SettingManager.SPORT_TYPE_HOCKEY:
                mHockey.setChecked(true);
                break;
            case SettingManager.SPORT_TYPE_TCHOUK:
                mTchoukball.setChecked(true);
                break;
        }
        ...
        mSportTypeButtons.add(mHandBall);
        mSportTypeButtons.add(mHockey);
        mSportTypeButtons.add(mTchoukball);
        OnCheckedChangeListener radioClickListener = new OnCheckedChangeListener() {
